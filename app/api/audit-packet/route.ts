...
export async function POST(request: Request) {
  ...
  page.drawText("Note: Crosswalk candidates and CAPA evidence must be reviewed before official scoring.", { x: 52, y: 102, size: 9, font, color: rgb(0.55, 0.32, 0.05) });
